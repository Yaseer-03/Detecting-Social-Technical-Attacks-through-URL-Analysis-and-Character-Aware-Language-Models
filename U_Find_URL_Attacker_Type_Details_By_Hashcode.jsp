...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 >Find URL Attacker Type Details By Hashcode!!!</h2>
          <div class="clr"></div>
		  <div class="post_content">
		  <p>&nbsp;</p>
           <form name="s"  action="U_Find_URL_Attacker_Type_Details_By_Hashcode1.jsp" method="post" >
<table width="423" border="0" align="center"  cellpadding="0" cellspacing="0" >
  <tr>
    <td width="217" height="50" valign="middle" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style10">Select  Attacker type with </div></td>
...
<td height="30" colspan="2" id="learn_more" align="center"  style="color:#FFFFFF;"><p>&nbsp;
  ...
  <p>
    <input type="submit" value="Find Dataset Details" style="width:400px; height:25px; background-color:#000000; color:#FFFFFF;"/>
    <br />
  </p></td>
</tr></div>
		  </table>
