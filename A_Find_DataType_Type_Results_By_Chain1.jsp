...
-->
          ...
          <div class="clr"></div>
           <%
						...
						try 
						{
						String str1 = " select distinct(DHashcode) from datasets ";
						Statement st1 = connection.createStatement();
						ResultSet rs1 = st1.executeQuery(str1);
						while(rs1.next())
						{
						    hsign = rs1.getString(1);
						   	String query="select * from datasets  where DHashcode = '"+hsign+"' "; 
...
<td  width="72" height="45"  valign="middle" bgcolor="#FFFF00" ><div align="center" class="style1 style12 style11"><strong>Data Type Hashcode </strong></strong></div></td>
         ...
         <h3 align="center">
<p align="center" class="style1"><span class="style1">Data Type Chain--->::</span> <%=s111%><br>
			    <span class="style1">Data Type Hash Code --->::</span><%=hsign%></p>
	     </h3>
			<div align="center">
			  <%
