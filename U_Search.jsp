...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style9 style10">A URL Based Social Semantic Attacks Detection With Character-Aware Language Model</a></h1>
      </div>
		  ...
		  <form name="s" action="U_Search.jsp" method="post" onSubmit="return valid()"  ons target="_top">   
                  ...
                  <Table align="center" style="margin:0 0 0 30px;">
                    ...
                    <tr>
                      <td COLSPAN="3"><div class="style2">
                        <div align="center" class="style13 style5">( Searching Datasets Based onURL,Attacker Type,Data Type)</div>
                      </div></td>
                    </tr>
                  </Table>
               </div>
                <P>&nbsp; </P>
				 ...
				 <p><%
	 				 ...
	 				 try
						{
								String s0,s1="",keyword="",s2="",s3="",s4="",s5="",s6="",up_Name="";
								...
								while(rs8.next())
									...
									s0 = rs8.getString(2); // uid
									s1 = rs8.getString(3); // URL Name
									s2 = rs8.getString(7); // Name
								    s3 = rs8.getString(8); // Links
									
									
					
								String t=s1.toLowerCase();
								String t1=s2.toLowerCase();
								String t2=s3.toLowerCase();
               ...
               <p class="style4"> 
               <div align="center" ><strong><span class="style5">UID :</span> <span class="style8"><%=s0%></span> </strong>
                 </p>
</div>
             
                <p><div align="center" class="style5"><strong>View <a href="U_Search1.jsp?uid=<%=s0%>">View Details</a></strong></div>
                </p>
                <p></p>
				<div>
