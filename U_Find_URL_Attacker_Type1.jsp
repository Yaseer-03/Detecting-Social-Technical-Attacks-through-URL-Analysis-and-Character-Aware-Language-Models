...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2 class="style3" style="color:#FF0033">URL Attacker  Type Results !!! </h2>
          ...
          <table width="310" height="92" border="3" align="center"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse;  margin:10px 10px 10px 10px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
					<tr bgcolor="#99FF33">
					<td  width="302" height="36" valign="baseline" bgcolor="#FF0000" style="color: #2c83b0;"><div align="center" class="style6 style11 style10">URL Attacker  Type Results</div></td>
...
try 
{
   ...
   String url=request.getParameter("url");
	...
	String query="select * from datasets where Uid='"+uid+"' and Url='"+url+"' "; 
