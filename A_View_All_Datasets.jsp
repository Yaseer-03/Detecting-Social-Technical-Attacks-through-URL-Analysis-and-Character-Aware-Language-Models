...
<div class="main">
  <div class="header">
    <div class="header_resize">
      <div class="logo">
        <h1><a href="index.html" class="style6">A URL Based Social Semantic Attacks Detection With Character-Aware Language ModelUsing Stacked Ensemble GCR-NN Model
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
		...
		<iframe width="800" height="700" src="A_View_All_Datasets1.jsp"></iframe>
